            ...
            <div className="registration-details-container">
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <div className="input-group">
                        ...
                        <select value={shoppingPreference} onChange={(e) => setShoppingPreference(e.target.value)} required>
                    ...
                    <div className="input-group">
                        ...
                        <div className="dob-group">
                            <input type="text" placeholder="Day" value={dob.day} onChange={(e) => setDob({ ...dob, day: e.target.value })} required />
                            <input type="text" placeholder="Month" value={dob.month} onChange={(e) => setDob({ ...dob, month: e.target.value })} required />
                            <input type="text" placeholder="Year" value={dob.year} onChange={(e) => setDob({ ...dob, year: e.target.value })} required />
                        </div>
                    </div>
                    <div className="checkbox-group">
                        <input type="checkbox" checked={agreeUpdates} onChange={() => setAgreeUpdates(!agreeUpdates)} />
